...
def main():
    ...
    prepare_args(coqui_tts_handler_kwargs, "coqui")
    ...
    if module_kwargs.tts == "parler":
        ...
        try:
            ...
            logger.error(
                "Error importing CoquiTTSHandler. You might need to run: python -m unidic download"
            )
            raise e
        tts = CoquiTTSHandler(
            stop_event,
        ...
        raise ValueError("The TTS should be either parler or coqui")
